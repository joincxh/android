...
public class MusicPlayerServices extends Service {
        ...
        if (timer == null) {
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    ...
                    Message msg = MainActivity2.handler.obtainMessage(); // 创建消息对象
    ...
    class MusicControl extends Binder {
        ...
        public void play() {
            mediaPlayer.reset();
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cuoweishikong);
            Log.i("MusicPlayerServices","播放音乐开始......");
            mediaPlayer.start();
            addTimer();
        }
        // 暂停
        public void pause() {
            Log.i("MusicPlayerServices","暂停音乐......");
            mediaPlayer.pause(); // 暂停音乐
        }
        // 继续
        public void resume() {
            Log.i("MusicPlayerServices","音乐继续......");
